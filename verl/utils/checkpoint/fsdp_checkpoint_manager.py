...
OFFLOAD_STATE_DICT_TO_CPU = is_cuda_available or is_npu_available
...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        state_dict_cfg = (
            ShardedStateDictConfig(offload_to_cpu=OFFLOAD_STATE_DICT_TO_CPU)
            if self.should_load_model
            else None
        )
        optim_cfg = (
            ShardedOptimStateDictConfig(offload_to_cpu=OFFLOAD_STATE_DICT_TO_CPU)
            if self.should_load_optimizer
            else None
        )
    ...
    def save_checkpoint(self, local_path: str, hdfs_path: str = None, global_step: int = 0, max_ckpt_to_keep=None):
        ...
        state_dict_cfg = ShardedStateDictConfig(offload_to_cpu=OFFLOAD_STATE_DICT_TO_CPU)
        optim_cfg = ShardedOptimStateDictConfig(offload_to_cpu=OFFLOAD_STATE_DICT_TO_CPU)
